 ...
 * `wings` drives the classic block models; the lofted builders also read
 * era/tail/planform/gear/blades (and `wingsDetailed` where the classic
 * approximation differs from the real planform).
 */
export const PLANES: PlaneDef[] = [
  { id: 'eindecker', label: 'Fokker Eindecker', year: 1915, desc: 'Fast steering, weak climb',
    form: { fuselage: 'box', nose: 'flat', nation: 'de', dihedral: 0.02, guns: true, era: 'ww1', livery: 'linen', tail: 'comma',
      wings: [{ y: 0.95, span: 10.8, chord: 2.1 }] },
  ...
  { id: 'camel', label: 'Sopwith Camel', year: 1917, desc: 'Balanced and agile',
    form: { fuselage: 'box', nose: 'radial', struts: 'quad', canopy: 'hump', nation: 'uk', guns: true,
      era: 'ww1', livery: 'pc10', tail: 'rounded', finScale: 0.62,
  ...
  { id: 'dr1', label: 'Fokker Dr.I', year: 1917, desc: 'Climbs like a demon',
    form: { fuselage: 'box', nose: 'flat', struts: 'quad', axleWing: true, nation: 'de', dihedral: 0, guns: true,
      era: 'ww1', livery: 'streak', tail: 'comma',
      wings: [
  ...
  { id: 'albatros', label: 'Albatros D.III', year: 1917, desc: 'Quick guns, light bomb load',
    form: { fuselage: 'round', nose: 'spinner', struts: 'pair', nation: 'de', guns: true, exhaust: true,
      era: 'ww1', livery: 'wood', tail: 'rounded', finScale: 0.7, cylinders: true,
  ...
  { id: 'spad', label: 'SPAD S.XIII', year: 1917, desc: 'Dives hard, sturdy gun platform',
    form: { fuselage: 'box', nose: 'flat', struts: 'quad', headrest: true, nation: 'fr', guns: true,
      era: 'ww1', livery: 'french', tail: 'rounded', finScale: 0.6, cylinders: true,
  ...
  { id: 'soptri', label: 'Sopwith Triplane', year: 1916, desc: 'The original three-decker climber',
    form: { fuselage: 'slim', nose: 'radial', struts: 'quad', nation: 'uk', guns: true,
      era: 'ww1', livery: 'pc10', tail: 'rounded', finScale: 0.6,
      wings: [
  ...
  { id: 'bristol', label: 'Bristol F.2', year: 1917, desc: 'Two-seater: heavy bomb load',
    form: { fuselage: 'deep', nose: 'flat', struts: 'quad', gunner: true, nation: 'uk', guns: true,
      era: 'ww1', livery: 'pc10', tail: 'rounded', finScale: 0.75,
  ...
  { id: 'd7', label: 'Fokker D.VII', year: 1918, desc: 'The best all-round of the Great War',
    form: { fuselage: 'box', nose: 'flat', struts: 'quad', nation: 'de', guns: true,
      era: 'ww1', livery: 'lozenge', tail: 'fokker', cylinders: true,
  ...
  { id: 'p26', label: 'P-26 Peashooter', year: 1932, desc: 'Interwar speedster',
    form: { fuselage: 'box', nose: 'radial', gear: 'spat', headrest: true, nation: 'us', dihedral: 0.05, guns: true,
      era: 'ww1', livery: 'interwar', tail: 'rounded', finScale: 0.8, blades: 2,
      wings: [{ y: 0.55, span: 9.8, chord: 1.9, planform: 'taper', taper: 0.7 }] },
  ...
  { id: 'gladiator', label: 'Gloster Gladiator', year: 1937, desc: 'The last great biplane',
    form: { fuselage: 'box', nose: 'radial', struts: 'pair', canopy: 'closed', gear: 'spat', nation: 'uk', dihedral: 0.04, guns: true,
      era: 'ww2', livery: 'raf', tail: 'rounded', finScale: 0.85, blades: 2, wires: true,
  ...
  { id: 'i16', label: 'Polikarpov I-16', year: 1934, desc: 'Stubby, twitchy, fast',
    form: { fuselage: 'stubby', nose: 'radial', headrest: true, nation: 'ussr', dihedral: 0.06,
      era: 'ww2', livery: 'soviet', tail: 'rounded', finScale: 0.8, gear: 'retract', blades: 2,
      wings: [{ y: 0.55, span: 9.4, chord: 2.0, planform: 'taper', taper: 0.5 }] },
  ...
  { id: 'spitfire', label: 'Spitfire Mk I', year: 1938, desc: 'Legendary handling',
    form: { fuselage: 'slim', nose: 'spinner', canopy: 'closed', scoop: true, nation: 'uk', dihedral: 0.08, exhaust: true,
      era: 'ww2', livery: 'raf', tail: 'rounded', finScale: 1.1, gear: 'retract', blades: 3,
      // Two overlapped spans approximate the elliptical wing in the classic blocks.
      wings: [{ y: 0.5, span: 11.4, chord: 2.0 }, { y: 0.52, span: 7.2, chord: 2.8 }],
      wingsDetailed: [{ y: 0.5, span: 11.4, chord: 2.7, planform: 'elliptical', thick: 0.12 }] },
  ...
  { id: 'bf109', label: 'Bf 109 E', year: 1939, desc: 'Ruthless diving attacker',
    form: { fuselage: 'slim', nose: 'spinner', canopy: 'closed', nation: 'de', dihedral: 0.07, exhaust: true,
      era: 'ww2', livery: 'splinter', tail: 'angular', gear: 'retract', blades: 3,
      wings: [{ y: 0.5, span: 9.8, chord: 2.1, planform: 'taper', taper: 0.55 }] },
  ...
  { id: 'p40', label: 'P-40 Flying Tiger', year: 1941, desc: 'Shark mouth, heavy bomb load',
    form: { fuselage: 'deep', nose: 'chin', mouth: true, canopy: 'closed', nation: 'us', dihedral: 0.07, exhaust: true,
      era: 'ww2', livery: 'olive', tail: 'square', gear: 'retract', blades: 3,
      wings: [{ y: 0.5, span: 11, chord: 2.5, planform: 'taper', taper: 0.55 }] },
    steer: 55, climb: 15, dive: 21, bombs: 36, gunMs: 115,
    body: 0x55663f, wing: 0x6b7c4d, detail: 0xd8e4ee, xp: 43000 },
  { id: 'p38', label: 'P-38 Lightning', year: 1941, desc: 'Fork-tailed devil: twin booms, nose cannon, 40 bombs',
    form: { fuselage: 'p38', nose: 'spinner', nation: 'us', era: 'ww2', livery: 'olive', gear: 'retract', dihedral: 0.08, wings: [],
      wingsDetailed: [{ y: 0.55, span: 15.6, chord: 2.7, planform: 'taper', taper: 0.5, thick: 0.13 }] },
    steer: 57, climb: 16, dive: 23, bombs: 40, gunMs: 105,
    body: 0x556049, wing: 0x68705a, detail: 0x9aa2ab, xp: 46000 },
  { id: 'p51', label: 'P-51 Mustang', year: 1944, desc: 'Silver bullet — the finest of all',
    form: { fuselage: 'slim', nose: 'spinner', canopy: 'bubble', scoop: true, nation: 'us', dihedral: 0.09, exhaust: true,
      era: 'ww2', livery: 'metal', tail: 'square', gear: 'retract', blades: 4, metal: true,
      wings: [{ y: 0.5, span: 11, chord: 2.2, planform: 'taper', taper: 0.55 }] },
  ...
  { id: 'tbf', label: 'TBF Avenger', year: 1942, desc: 'Navy torpedo bomber: 46 bombs, built like a tank',
    form: { fuselage: 'tbf', nose: 'radial', nation: 'us', era: 'ww2', livery: 'navy', tail: 'rounded', finScale: 1.4, gear: 'retract', blades: 3, wings: [],
      wingsDetailed: [{ y: 1.0, span: 15.4, chord: 2.9, planform: 'taper', taper: 0.5, thick: 0.15, dihedral: 0.1 }] },
  ...
  { id: 'me262', label: 'Me 262 Schwalbe', year: 1944, desc: 'The first jet — nothing else comes close',
    form: { fuselage: 'me262', nose: 'spinner', nation: 'de', era: 'ww2', livery: 'rlmlate', tail: 'angular', finScale: 1.3, gear: 'retract', wings: [],
      wingsDetailed: [{ y: 0.45, span: 12.6, chord: 2.4, planform: 'taper', taper: 0.45, sweep: 0.3, thick: 0.11 }] },
  ...
  { id: 'ho229', label: 'Horten Ho 229', year: 1945, desc: 'Flying wing — decades ahead of its time',
    form: { fuselage: 'ho229', nose: 'spinner', nation: 'de', era: 'ww2', livery: 'rlmlate', gear: 'retract', wings: [] },
